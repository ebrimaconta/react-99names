...
function RenderAsma() {
  useEffect(() => {
    document.title =
      'SubhanAllaah page not found!!! What page are you looking for ?';
  });
  return (
    <>
      <div className='text-white  h-full flex flex-col items-center  content-center justify-center '>
        <div className='text-center  w-full  h-48 bg-space-green pb-10'>
          <div className='text-4xl capitalize animate__jackInTheBox  animate__animated animate__slow'>
            404 error
          </div>
        ...
        <div className='flex w-full h-screen '>
          <Link to='/' className='w-full h-48 contents'>
            <div className='bg-space-red  w-full text-center py-10 text-3xl capitalize flex flex-col  justify-center animate__slideInLeft animate__animated animate__slow'>
          ...
          <Link to='/asma' className='w-full h-48 contents'>
            <div className='bg-space-blue  w-full text-center  py-10 text-3xl capitalize flex flex-col  justify-center animate__slideInRight  animate__slow animate__animated'>
