      ...
      <div className="text-white  h-full flex flex-col items-center  content-center justify-center ">
        ...
        <div className="flex w-full h-screen ">
          <Link to="/" className="w-full h-48 contents">
            <div className="bg-space-blue-blue-blue-blue-blue-blue w-full text-center py-10 text-3xl capitalize flex flex-col  justify-center animate__slideInLeft animate__animated animate__slow">
          ...
          <Link to="/asma" className="w-full h-48 contents">
            <div className="bg-space-blue-blue-blue-blue-blue-blue-red w-full text-center  py-10 text-3xl capitalize flex flex-col  justify-center animate__slideInRight  animate__slow animate__animated">
